...
YC_BUCKET_NAME = os.getenv("YC_BUCKET_NAME", "webapp-tgmini")  # имя бакета
YC_S3_ENDPOINT = os.getenv("YC_S3_ENDPOINT", "https://storage.yandexcloud.net")
YC_WEBSITE_HOST = os.getenv(
    "YC_WEBSITE_HOST",
    "webapp-tgmini.website.yandexcloud.net",  # твой домен хостинга
)
GITHUB_TOKEN = os.getenv("GITHUB_TOKEN")
NETLIFY_URL = os.getenv("NETLIFY_URL")  # URL твоего Netlify сайта
GITHUB_REPO = os.getenv("GITHUB_REPO")  # Например, "username/repo"