...
def upload_map_html(local_path: str, object_key: str) -> str:
    ...
    # Загружаем с указанием Content-Type, чтобы браузер отображал HTML
    try:
        bucket.upload_file(
            local_path,
            object_key,
            ExtraArgs={
                ...
                "CacheControl": "max-age=0" # Чтобы не кэшировалось жестко при отладке
            },
        )
    ...
    # Убедитесь, что бакет настроен как веб-сайт в консоли Yandex Cloud
