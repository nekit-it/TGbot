# handlers/view_map.py (или твой файл, где уже есть open_map_handler)
from aiogram import Router, F
from aiogram.types import CallbackQuery

from services.storage import get_user_maps   # или get_map, если такой есть
...
async def open_map_handler(callback: CallbackQuery):
    ...
    # если у тебя есть get_map(user_id, map_id) — используй его
